...
import { bookAppointment, cancelAppointment, getDoctorById, getDoctorsBySpeciality, getUserAppointments, updateProfile, userLogin, userRegister } from '../controllers/user.controller.js';
