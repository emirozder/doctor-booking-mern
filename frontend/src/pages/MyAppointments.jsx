        ...
        {doctors.slice(0, 1).map((doctor, index) => (
          ...
          >
            ...
            <div className="flex flex-col gap-2 justify-end">
              ...
              <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border hover:bg-red-600 hover:text-white transition-all duration-300 cursor-pointer">
                Cancel Appointment
              </button>
            </div>
          </div>
